...
public class createProject {
	...
	public void addProject() throws InterruptedException, IOException {
		...
		wdWait.until(ExpectedConditions
				.visibilityOfElementLocated(By.cssSelector(".right_menu_list .right_menu_item:nth-child(2)"))).click();
		;
		wdWait.until(ExpectedConditions
				.visibilityOfElementLocated(By.cssSelector(".menu_container .menu_item:nth-child(4)"))).click();

		// projectName = driver.findElement(By.cssSelector(".list_container
		// .list_item[data-name='Project_1'] .list_item_name")).getText();
		...
		if (noOfProjects == 0) {
			...
			wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#project_name")))
					.sendKeys(projectName);
			wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#project_description")))
					.sendKeys(projectName);
		...
		// wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".menu_container
		// .menu_item:nth-child(5)"))).click();
	}
