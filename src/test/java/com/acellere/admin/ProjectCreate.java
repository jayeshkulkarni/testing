...
public class ProjectCreate {
 ...
 public static void initDriver() throws Exception
 {
  ...
  public void navigateToProjectPage() 
  {
	 ...
	 we.click();	
	 we = wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".right_menu_list .right_menu_item:nth-child(2)")));
	 we.click();
	 we = wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".menu_container .menu_item:nth-child(4)")));
	 we.click();
  }
