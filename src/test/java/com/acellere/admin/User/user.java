...
public class user {
	...
	public void addnewUSer() throws Exception {
		...
		driver.findElement(By.cssSelector(pro.getProperty("gamma.adduser.jobtitle.cssSelector")))
				.sendKeys("Administrator");
		driver.findElement(By.cssSelector(pro.getProperty("gamma.adduser.email.cssSelector")))
		...
		driver.findElement(By.cssSelector(pro.getProperty("gamma.adduser.confirm_password.cssSelector")))
				.sendKeys("admin123");
