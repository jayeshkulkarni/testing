...
public class createSubsystem {
	...
	public void addSubsystem() throws InterruptedException, IOException {
		...
		wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/div[5]/div[2]/div/div[3]")))
				.click();
		Thread.sleep(1000);
		wdWait.until(ExpectedConditions
				.visibilityOfElementLocated(By.cssSelector(".menu_container .menu_item:nth-child(5)"))).click();
		Thread.sleep(1000);
		...
		for (WebElement obj : we) {
			...
			} else if (obj.getText().equals("svn")) {
		 ...
		 * cssSelector(".dropDown_list .dropdown_list_item .language_text[data-language_id='zip']"
		 * )).click(); driver.findElement(By.
		 * cssSelector(".dropDown_list .dropdown_list_item .language_text[data-language_id='zip']"
		 * )).click(); driver.findElement(By.cssSelector("#subsystem_name")).sendKeys(
		 * "elliptics_ell"); Thread.sleep(2000); driver.findElement(By.
		 * cssSelector(".element_wrapper .dropdown[data-label='language']")).click();
		 * 
		 * // driver.findElement(By.
		 * cssSelector(".dropDown_list .dropdown_list_data:nth-child(0)")).click();
		 * wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.
		 * cssSelector(".dropDown_list .dropdown_list_data:nth-child(2)"))).click();
		 * Thread.sleep(1000);
		 * driver.findElement(By.cssSelector("#codeuploader")).click();
		 * Thread.sleep(1000); Runtime.getRuntime().exec(
		 * "C:\\Users\\RahulG\\Desktop\\AutoIT\\uploadZip3.exe"); Thread.sleep(1000);
		 * driver.findElement(By.cssSelector(".addSubsystemBtn")).click();
		 * //driver.findElement(By.cssSelector("#url")).sendKeys(
		 * "https://github.com/reverbrain/elliptics.git") //
		 * driver.findElement(By.cssSelector("#subsystem_name")).sendKeys(
		 * "Elliptics_git"); // driver.findElement(By.
		 * cssSelector(".element_wrapper .dropdown[data-label='language']")).click(); //
		 * driver.findElement(By.
		 * cssSelector(".dropDown_list .dropdown_list_data:nth-child(1)")).click();
		 */
	}
}
