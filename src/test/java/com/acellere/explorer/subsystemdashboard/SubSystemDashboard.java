...
public class SubSystemDashboard 
{
	...
	public static String[] panelTitleActual = new String[]
			{"Design","Metrics", "Duplication","Code Quality"};
  ...
  public static void navigateSubSystemOverviewPanel() 
  {
  	...
  	public static void verifyPanels()
  	{
  		for(int i=1; i<=4; i++)
  		{
  		we = driver.findElement(By.cssSelector("div.project_issue_container:nth-child("+i+") .project_issue_title .issue_name"));
