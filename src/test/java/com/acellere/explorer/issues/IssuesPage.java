package com.acellere.explorer.issues;
...
public class IssuesPage {
  ...
  public static String panelTitleActual = "Issues";
  ...
  @Test(priority = 1)
  public static void navigateIssues() throws InterruptedException
  {
	  System.out.println("------------------------------Start of Test------------------------------");
	  Reporter.log("Executing "+IssuesPage.class.getName()+".....!!!",true);
	     Thread.sleep(500);
		 ...
		 we = wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".plugin_group:nth-child(7) .plugin")));
		 we.click();
