...
public class SubSystem {
  ...
  public void Subsystem_Count() throws Exception
  {
	  ...
	  for(int i=1; i<=project_count; i++)
	  {
		  ...
		  {
			  List<WebElement> list_of_subsystem = driver.findElements(By.cssSelector("div.project_list:nth-child("+j+")"));
			  for(WebElement we1:list_of_subsystem)
			  {
				  Log.info("Subsystem Name :-" +we1.getAttribute("data-name"));
				  ss_rating = driver.findElement(By.cssSelector("div.project_list:nth-child("+j+") div.project_rating div.h2")).getText();
				  ss_loc_count = driver.findElement(By.cssSelector("div.project_list:nth-child("+j+") div.loc_count")).getText();
  ...
  private static List<String> get_array(String sortBy){
	...
	public static void sort_by_name() 
	{
		...
		wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.project_list:nth-child(2)"))).click();
		subsystem_count = driver.findElements(By.cssSelector(".subsystem_list_container .project_list")).size();
		 Log.info("subsystem_count");
	...
	public static void sort_by_size()
	{
	    ...
	    we = wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.dropDown_list li:nth-child(4) li div")));
		we.click();
