...
public class TeamList {
	...
	for(int i=1; i<=team_size; i++)
	{
		...
		we = driver.findElement(By.cssSelector(".team_list_container .teamList_list:nth-child("+i+") .team_name"));
		we.getText();
		System.out.println("Team name:- "+we.getText());
		for(int j =1; j <= 4; j++)
		{
			we = driver.findElement(By.cssSelector(".team_list_container .teamList_list:nth-child("+i+") div.team_details_wrapper div.team_detail:nth-child("+j+") div.title_wrapper"));
			we.getText();
			System.out.print(we.getText());
			System.out.print(" :- "); 
			we = driver.findElement(By.cssSelector(".team_list_container .teamList_list:nth-child("+i+") div.team_details_wrapper div.team_detail:nth-child("+j+") div.count_wrapper"));
			we.getText();
