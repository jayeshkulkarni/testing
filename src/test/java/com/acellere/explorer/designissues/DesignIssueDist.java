package com.acellere.explorer.designissues;
...
public class DesignIssueDist {
  
  //private static Logger Log = Logger.getLogger(Log.class.getName());
  public static WebDriver driver;
  public static WebDriverWait wdWait;
  public static WebElement we;
  public static String panelTitleActual = "Design Issues Distribution";
  ...
  @Test(priority = 1)
  public static void navigateDesignIssueDistribution() throws InterruptedException
  { 
	  System.out.println("------------------------------Start of Test------------------------------");
	  Reporter.log("Executing "+DesignIssueDist.class.getName()+".....!!!",true);
	  try {
			Thread.sleep(500);
		 ...
		 we = wdWait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".plugin_group:nth-child(2) .plugin:nth-child(2)")));
		 we.click();
