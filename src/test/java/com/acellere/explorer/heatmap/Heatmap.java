package com.acellere.explorer.heatmap;
...
public class Heatmap {
    ...
    public static String panelTitleActual = "Heatmap";
  ...
  @Test(priority = 1)
  public static void navigateHeatMap() 
  {
	  System.out.println("------------------------------Start of Test------------------------------");
	  Reporter.log("Executing "+Heatmap.class.getName()+".....!!!",true);
	  	try {
			Thread.sleep(500);
		 ...
		 we = wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".plugin_group:nth-child(6) .plugin")));
		 we.click();
