package com.acellere.explorer.metrics;
...
public class MetricsDist {
  
  //private static Logger Log = Logger.getLogger(Log.class.getName());
  public static WebDriver driver;
  public static WebDriverWait wdWait;
  public static WebElement we;
  public static String panelTitleActual = "Metrics Distribution";
  ...
  @Test(priority = 1)
  public static void navigateMeticsDistribution() throws InterruptedException
  {
	  System.out.println("------------------------------Start of Test------------------------------");
	  Reporter.log("Executing "+MetricsDist.class.getName()+".....!!!",true);
	  try {
			Thread.sleep(500);
		 ...
		 we = wdWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".plugin_group:nth-child(2) .plugin:nth-child(3)")));
		 we.click();
